...
/* harmony import */ var _AllUsers_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AllUsers.vue */ "./resources/js/src/views/manage-user/AllUsers.vue");
...
/* harmony import */ var _dashboard_analytics_AnalyticsCongratulation_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./../dashboard/analytics/AnalyticsCongratulation.vue */ "./resources/js/src/views/dashboard/analytics/AnalyticsCongratulation.vue");
/* harmony import */ var _dashboard_analytics_AnalyticsAvgSessions_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./../dashboard/analytics/AnalyticsAvgSessions.vue */ "./resources/js/src/views/dashboard/analytics/AnalyticsAvgSessions.vue");
/* harmony import */ var _dashboard_analytics_AnalyticsSupportTracker_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./../dashboard/analytics/AnalyticsSupportTracker.vue */ "./resources/js/src/views/dashboard/analytics/AnalyticsSupportTracker.vue");
/* harmony import */ var _dashboard_analytics_AnalyticsTimeline_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./../dashboard/analytics/AnalyticsTimeline.vue */ "./resources/js/src/views/dashboard/analytics/AnalyticsTimeline.vue");
/* harmony import */ var _dashboard_analytics_AnalyticsSalesRadarChart_vue__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./../dashboard/analytics/AnalyticsSalesRadarChart.vue */ "./resources/js/src/views/dashboard/analytics/AnalyticsSalesRadarChart.vue");
/* harmony import */ var _dashboard_analytics_AnalyticsAppDesign_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./../dashboard/analytics/AnalyticsAppDesign.vue */ "./resources/js/src/views/dashboard/analytics/AnalyticsAppDesign.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    AnalyticsCongratulation: _dashboard_analytics_AnalyticsCongratulation_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    AnalyticsAvgSessions: _dashboard_analytics_AnalyticsAvgSessions_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
    AnalyticsSupportTracker: _dashboard_analytics_AnalyticsSupportTracker_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
    AnalyticsTimeline: _dashboard_analytics_AnalyticsTimeline_vue__WEBPACK_IMPORTED_MODULE_13__["default"],
    AnalyticsSalesRadarChart: _dashboard_analytics_AnalyticsSalesRadarChart_vue__WEBPACK_IMPORTED_MODULE_14__["default"],
    AnalyticsAppDesign: _dashboard_analytics_AnalyticsAppDesign_vue__WEBPACK_IMPORTED_MODULE_15__["default"]
  },
  data: function data() {
    return {
      ...
      passwordConfirm: "",
      email: "",
      confirmed: _validations__WEBPACK_IMPORTED_MODULE_5__["confirmed"],
      validationErrors: "",
      info: "",
      name: "",
      //   last_name:'',
  ...
  methods: {
    getAllCurrencies: function getAllCurrencies() {
      ...
      _api_admin__WEBPACK_IMPORTED_MODULE_7__["default"].getData("getAllCurrencies", function (res) {
    ...
    getAllUserLevels: function getAllUserLevels() {
      ...
      _api_admin__WEBPACK_IMPORTED_MODULE_7__["default"].getData("getAllUserLevels", function (res) {
        for (var i = 0; i < res.data.length; i++) {
    ...
    validationForm: function validationForm() {
      ...
      this.$refs.simpleRules.validate().then(function (success) {
        if (success) {
          ...
          _api_admin__WEBPACK_IMPORTED_MODULE_7__["default"].createUser(_this3.info = {
            name: _this3.name,
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._v(" "), _c("AllUsers", { ref: "AllUsersComponent" })],
        1
      ),
      _vm._v(" "),
      _c(
          ...
          scopedSlots: _vm._u([
            {
              ...
              fn: function () {
                return [
                  _c("feather-icon", {
                    staticClass: "mr-50",
                    attrs: { icon: "UserPlusIcon", size: "18" },
                  }),
                  _vm._v(" "),
                  _c("span", { staticClass: "font-weight-bold" }, [
                    _vm._v("Add User"),
        ...
        [
          _vm._v(" "),
          _c("CreateUser", { on: { "event-triggered": _vm.getAllUsers } }),
        ],
        1
      ),
    ],
