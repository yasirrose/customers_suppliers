  ...
  methods: {
    ...
    actionRecords: function actionRecords(param) {
      ...
      this.$swal({
        ...
        if (result.value) {
          _api_admin__WEBPACK_IMPORTED_MODULE_7__["default"].deleteUser(_this2.info = {
            id: _this2.idArray,
            param: param
          }, function (data) {
            if (data.success) {
  ...
  methods: {
    ...
    actionRecords: function actionRecords(param) {
      ...
      this.$swal({
        ...
        if (result.value) {
          _api_admin__WEBPACK_IMPORTED_MODULE_7__["default"].actionProducts(_this2.info = {
            id: _this2.idArray,
            param: param
          }, function (data) {
            if (data.success) {
