...
/* harmony import */ var _core_mixins_ui_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @core/mixins/ui/forms */ "./resources/js/src/@core/mixins/ui/forms.js");
...
/* harmony import */ var _api_login__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../api/login */ "./resources/js/api/login.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mixins: [_core_mixins_ui_forms__WEBPACK_IMPORTED_MODULE_5__["togglePasswordVisibility"]],
  data: function data() {
    return {
      status: '',
      password: 'admin',
  ...
  computed: {
    ...
    imgUrl: function imgUrl() {
      if (_store_index__WEBPACK_IMPORTED_MODULE_6__["default"].state.appConfig.layout.skin === 'dark') {
    ...
    login: function login() {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          ...
          _api_login__WEBPACK_IMPORTED_MODULE_9__["default"].getUserInfo(info, function (data) {
            if (data.success) {
              _this.$toast({
...
var login = {
  getUserInfo: function getUserInfo(data, cb, errorCB) {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(window.API_URL + 'login', data).then(function (resp) {
      if (resp.status == 200) {
        cb(resp.data);
      }
    })["catch"](function (err) {
  ...
  logout: function logout(cb, errorCB) {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(window.API_URL + 'logout').then(function (resp) {
      if (resp.status == 200) {
        cb(resp.data);
      }
    })["catch"](function (err) {
